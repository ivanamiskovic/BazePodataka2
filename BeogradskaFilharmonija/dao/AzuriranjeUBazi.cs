        ...
        public static int AzurirajClanKluba(int sfr, string jmbg, string imeck, string przck, string korime, string datrodj)
        {
            ...
            using (var db = new BeogradskaFilharmonijaModelContainer())
            {
                ...
                try
                {
                    ...
                    if (clan_Kluba.korime == korime)
                    {
                        return 1; //ako ne promenim korisnicko ime izbacice gresku, ovde mi je uslov da korisnicko ime mora biti promenjeno
                    }
                    else
                    {
                        clan_Kluba.korime = korime;
                    }
