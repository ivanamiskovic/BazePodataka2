...
namespace BeogradskaFilharmonija
{
    ...
    public partial class BeogradskaFilharmonijaModelContainer : DbContext
    {
        public BeogradskaFilharmonijaModelContainer()
            : base("name=BeogradskaFilharmonijaModelContainer")
        {
        }
